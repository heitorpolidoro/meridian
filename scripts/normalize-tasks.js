...
// Everything happens inside main(): reading the registry at module scope
// meant importing this file did the work, and threw where there was none.
function main() {
    ...
    for (const { path: projPath } of projects) {
        ...
        try {
            ...
            // A malformed tasks.json is never normalized away: writing here
            // would replace the backlog with an empty array. Skip it and
            // report loudly.
