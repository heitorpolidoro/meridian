...
function getTasks(projPath) {
    ...
    if (Array.isArray(parsed)) {
        return { tasks: backfillTasks(parsed) };
    }
    if (parsed && typeof parsed === 'object' && Array.isArray(parsed.tasks)) {
        return { tasks: backfillTasks(parsed.tasks || []) };
    }
...
module.exports = { deriveKey, nextTaskId, getTasks, saveTasks, stampNewTask, stampTaskUpdate, normalizeStatus, MalformedTasksError };
