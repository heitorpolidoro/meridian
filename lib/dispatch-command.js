...
function dispatchCommand(tool, taskId) {
    // The rule itself is owned by lib/tasks.js — this is just the call site
    // that refuses rather than throws, because a bad id here means "no
    // command", not an exception.
